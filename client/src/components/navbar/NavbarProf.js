    ...
    <>
      ...
      <div className="border-top border-bottom border-2 py-5 mb-5">
        <Link to="/profile" className="d-block mb-5 nav-item">
          <img src="/assets/icons/red-user.png" alt="icon" style={{width: "22px", height: "22px"}}/>
          <span className="fc-red ms-3 h5">Profile</span>
        </Link>
        <Link to="/subscribe" className="d-block nav-item">
          <img src="/assets/icons/bill.png" alt="icon" style={{width: "24px", height: "26px"}}/>
